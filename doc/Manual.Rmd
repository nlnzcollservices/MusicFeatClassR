...
As for data extractor , train classifier also has S3 plot method which is currently not working. So, if it does not work, please run S3 method script first.
